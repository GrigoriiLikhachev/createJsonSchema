...
def create_work_dictionary(df_import, parametr = 0):
    name_list_df = list(df_import)
...
a = 0
if a == 1:
    random_values_dictionary = random_values_dictionary.create_random_dictionary_of_dictionary()
...
for _ in dict_['xls']:
    for __ in dict_['xls'][_]:
        ...
        if ___:
            work_dictionary_work = create_work_dictionary(df_import, 1)
